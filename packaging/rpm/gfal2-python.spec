...
# git clone --branch master https://gitlab.cern.ch/dmc/gfal2-bindings.git gfal2-python-1.9.3
# pushd gfal2-python-1.9.3
# git checkout v1.9.3
# popd
# tar czf gfal2-python-1.9.3.tar.gz --exclude-vcs gfal2-python-1.9.3
